...
\hl{Il serait possible d'envisager que les perturbations environnementales affectent en premier lieu le bas de la chaîne alimentaire, avant de se propager à travers le réseau trophique jusqu'aux prédateurs} \citep{Chauvat2014Responsesoil,Laigle2021Directindirect}. 
