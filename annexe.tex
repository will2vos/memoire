...
\begin{table}[ht!]
\caption[\hspace{0.3cm} JAGS code used to estimate impact of overstory treatments on Red-backed salamanders (\textit{Plethodon cinereus}) and carabids occupancy, springtail biomass and environmental variables that could effect soil fauna habitat selection.]
