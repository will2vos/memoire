...
Les environnements forestiers jouent un rôle majeur à l’échelle planétaire à travers leurs fonctions écosystémiques et l'apport économique qu’ils représentent en fournissant de nombreux biens et services \citep{Balvanera2006Quantifyingevidence}. 
...
L'aménagement écosystémique a ainsi été suggérée comme une stratégie pour une gestion forestière durable \citep{Perry1998scientificbasis,Kuuluvainen2002Naturalvariabilitya}. 
...
Plus précisément, l'aménagement écosystémique utilise les traitements sylvicoles à l'échelle des peuplements, comme la coupe totale et la coupe partielle, pour reproduire les impacts écologiques associés aux perturbations naturelles. 
...
Cette pratique peut ainsi être intégrée dans une approche de gestion écosystémique visant à imiter des perturbations naturelles de grande ampleur, telles que les feux de forêt, et à favoriser le maintien des stades précoces de la succession forestière \citep{Bergeron1999Forestmanagementa}. 
De plus, certaines espèces d’arbres se régénèrent plus efficacement en coupe totale, en fonction de leur tolérance à l’ombre et de leur dépendance aux perturbations du sol \citep{Bergeron1999Forestmanagementa}. 
...
Les coupes partielles sont un autre exemple d'aménagement écosystémique visant à maintenir la composition, la structure et les fonctions de l'écosystème dans les limites de leur variabilité naturelle \citep{Bergeron1999Forestmanagementa,Raymond2009irregularshelterwood}.
...
Ainsi, les coupes partielles peuvent être appliquées afin de maintenir les stades de succession plus près de la dynamique naturelle des écosystèmes en forêt mixte \citep{Bergeron1999Forestmanagementa}. 
...
Les coupes partielles peuvent permettre une meilleure conservation des espèces associées au milieu forestier en maintenant des attributs importants comme les débris ligneux, 
...
Prédateur généraliste, la salamandre cendrée peut contribuer à la régulation des invertébrés détritivores, influençant ainsi les processus de décomposition, la circulation des nutriments dans les sols et la dynamique du carbone \citep{Burton1975Energyflow,Wyman1998Experimentalassessment,Walton2013Topdownregulation,Hickerson2017Easternredbacked}. 
...
Les changements environnementaux et les modifications d'habitat favorisent certaines espèces au détriment d'autres, ce qui rend leur diversité et leur sensibilité particulièrement intéressantes pour étudier l'impact des perturbations environnementales \citep{Niemela2001Carabidbeetles,Rainio2003Groundbeetles,Work2008Evaluationcarabid}. 
Ces insectes ont une courte durée de vie, occupent une position élevée dans la chaine alimentaire et réagissent rapidement et de manière complexe aux modifications de leur environnement \citep{loveiEcologyBehaviorGround1996,Niemela2001Carabidbeetles}.
...
Mon projet a pour but de combler cette lacune en essayant de comprendre comment les effets à court terme de différents types de récolte forestière se propagent à l’intérieur du réseau écologique forestier et influencent la dynamique de la faune du sol. 
...
L’hypothèse 1.1 attachée à notre premier objectif soutient que les variables environnementales (volume de débris ligneux, ouverture de la canopée, profondeur de litière) 
favorables à l’utilisation de l’habitat par les espèces varient selon l'intensité des coupes forestières, les traitements les plus intensifs entraînant les perturbations les plus importantes. 
