...
Afin d'améliorer nos connaissances et ainsi reduire l'incertitude, divers scénarios sylvicoles sont actuellement étudiés pour limiter les risques associés à la migration assistée \citep{royoDesiredREgenerationAssisted2023}.
...
Les coupes partielle sont souvent utilisée pour favoriser la croissance des arbres les plus vigoureux, pour encourager la diversité spécifique ou pour maintenir une canopée ouverte \citep{Ameray2021Forestcarbon,Irland2011Timberproductivity}.
...
De plus, les coupes peuvent affecter la disponibilité en nutriment et augmenter le degrée de compaction au niveau des sols \citep{Battigelli2004Shorttermimpact,Covington1981Changesforest,Lindo2003Microbialbiomass,rousseauLongtermEffectsBiomass2018}. 
...
Parmis les espèces vivant au sol, les amphibiens et les arthropodes font partie des taxons les plus impacter lors de perturbationss environnementales, 
...
Ces groupes sont ainsi couramment utilisès comme indicateurs de l'état des forêts et du degré de perturbation de celles-ci \citep{birdChangesSoilLitter2004,Maleque2009Arthropodsbioindicators,pongeVerticalDistributionCollembola2000}.
...
Cette salamandre occupe les sols forestier lorsque la température et le niveau d'humidité sont optimal pour effectuer sa respiration cutanée. 
...
Le déplacement vertical des salamandres cendrée suit un cycle saisonnier et l'abondance des individus à la surface est habituellement plus grande durant le printemps et l'automne \citep{FraserEmpiricalEvaluation1976,Jaeger1980MicrohabitatsTerrestrial}.
...
Plusieurs études se sont ainsi interréssées à l'utilisation de l'habitat \citep{Baecher2018Environmentalgradients,gibbsDistributionWoodlandAmphibians1998,Heatwole1962EnvironmentalFactors,Mossman2019Twosalamander}, 
...
Cette famille rassemble la plus fortes diversités spécifiques parmi les coléoptères avec 40,000 espèces identifiés \citep{Erwin1985taxonpulse} 
...
Ce groupe est largement répandu dans les écosysteme terrestres et se retrouve dans une grand variété de milieu naturels \citep{Larochelle2003naturalhistory}. 
Toutefois, la selection d'habitat varie selon l'espèce, ce qui entraine une différence de communauté en fonction du type d'habitat.
Les carabes sont ainsi couramment classés selon trois type de communauté : les espèces des milieux forestiers mature et fermé, les espèces des milieux ouvert et les espèces généralistes \citep{Niemela2007effectsforestry}. 
Cette variation dans la sélection d'habitat font des carabes un des taxons les plus interressant à étudier lors de perturbations environnementales.
