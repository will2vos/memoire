...
Les écosystèmes forestiers jouent un rôle prédominant à l’échelle planétaire à travers le rôle économique et l’apport écosytémique qu’ils consituent en fournissant de nombreux biens et services \citep{Balvanera2006Quantifyingevidence}. 
Ces écosytèmes permettent de réguler les flux de nutriment et d’énergie en participant notamment a la séquestration du carbone, à la régulation du climat, à la rétention de l’eau ainsi qu’a la conservation de la biodiveristé \citep{Balvanera2006Quantifyingevidence,Diaz2006BiodiversityLoss,Canadell2008Managingforests,Pawson2013Plantationforests}. 
Toutefois, la croissance démographique et l’augmentation des besoins en produits forestiers conduisent à une hausse de l’exploitation forestière depuis plusieurs décennies \citep{Foley2005GlobalConsequences}. 
Ainsi, le changement d’affectations des terres issues de la récolte de bois, de l’agriculture et de l’urbanisation amène une diminution du territoire associé aux écosytème forestiers et une perte de biodiversité \citep{Bengtsson2000Biodiversitydisturbances,Sala2000Globalbiodiversity,Naeem2012functionsbiological,Bichet2016Maintaininganimal}. 
...
Les coupes forestières peuvent également causer des problèmes de connectivité entre les différents habitats, les groupes d'espèces et les processus écologiques, ce qui peut affecter négativement la conservation de la faune \citep{Lindenmayer2006Generalmanagement}. 
...
Les coupes forestières sont l'une des interventions sylvicoles qui ont un impact important sur les milieux naturels. 
Cependant, selon le type de traitement utilisé, le niveau de perturbation provoqué par ces coupes varie, allant de perturbations proches du naturel ou semi-naturel dans le cadre de la gestion forestière extensive à des perturbations plus artificielles dans le cas de la gestion forestière intensive \citep{Ameray2021Forestcarbon}. 
Les méthodes utilisées seront principalement déterminées par les objectifs économiques et écologiques établis par le plan d'aménagement.
...
Les pratiques sylvicoles qui favorise la préservation de la biodiversité ont été encouragées, au cours des dernières décennies, afin de réduire les effets néfastes de la gestion intensive \citep{Gustafsson2012Retentionforestry}. 
La gestion écosystémique a été suggérée comme une stratégie pour une gestion forestière durable \citep{Perry1998scientificbasis,Kuuluvainen2002Naturalvariabilitya}. 
...
La gestion des forêts est d'autant plus complexe en raison des changements climatiques, en plus du défi de préserver la biodiversité et les écosystèmes forestiers, tout en répondant aux besoins économiques.
La montée des températures constitue une menace supplémentaire pour la préservation de la faune et de la flore en entraînant des changements importants dans les conditions environnementales \citep{McKenney2009Climatechange,Trumbore2015Foresthealth,Seidl2017Forestdisturbances,Messier2022Warningnatural}. 
...
La faune du sol joue un rôle essentiel dans les écosystèmes forestier, en contribuant à la circulation de la matière et de l'énergie à travers la chaîne alimentaire, ainsi qu'au recyclage des nutriments \citep{Seibold2021contributioninsects,Kudrin2023metaanalysiseffects}. 
Toutefois, ces espèces sont parmis les plus touchées par les perturbations environnementales \citep{Marshall2000Impactsforest,Coyle2017Soilfauna}. 
Les organismes du sol ont une capacité de dispersion limitée en raison de leur petite taille, ce qui les rend particulièrement exposés aux changements dans leur habitat \citep{Kudrin2023metaanalysiseffects}. 

Les coupes forestières peuvent ainsi entraîner des changements brusques dans les habitats forestiers et avoir des effets négatif sur la faune du sol \citep{Lindo2003Microbialbiomass,Paillet2010Biodiversitydifferences,Fedrowitz2014Canretention,Chaudhary2016Impactforest}. 
...
Les modifications de la structure du sol, telles qu'une compaction accrue due au passage des machines forestières, ont également un impact sur la porosité du sol et, par conséquent, sur la faune qui y vit \citep{Battigelli2004Shorttermimpact,Mazerolle2021Woodlandsalamander}. 
...
Malgré le fait qu'ils soient abondants dans les forêts nord-américaines, les amphibiens et les arthropodes ne sont pas souvent pris en compte dans les plans de gestion forestière \citep{deMaynadier1995relationshipforest}. 
Ces groupes d'espèces ont cependant un rôle important dans l'écologie forestière, notamment au niveau de la chaine trophique et dans la circulation du carbone au niveau des sols. 
De plus, les amphibiens et les arthropodes ont connu un déclin significatif au cours des dernières décennies, principalement en raison des pratiques d'aménagement forestier et des changements climatiques \citep{Houlahan2000Quantitativeevidence,Stuart2004Statustrends,Warren2018projectedeffect,Wagner2021Insectdecline}. 
