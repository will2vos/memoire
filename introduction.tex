...
La sensibilité de cette salamandre aux perturbations environnementales en raison de sa respiration cutanée en fait un bon indicateur de la qualité environnementale des sols forestier \citep{Welsh2001caseusing}.
Elle est couramment employée en tant que bio-indicateur pour évaluer les perturbations environnementales associées aux traitements sylvicoles.
D'ailleurs, plusieurs études se sont ainsi intéressées à l’utilisation de l’habitat \citep{Baecher2018Environmentalgradients,gibbsDistributionWoodlandAmphibians1998,Heatwole1962EnvironmentalFactors,Mossman2019Twosalamander}, 
...
La plupart des travaux s'intéressant à l'impact des traitements sur la faune discutent des effets directs des perturbations sur un ou plusieurs groupes d'espèces, 
...
Mon projet comblait justement cette lacune en essayant de comprendre les effets des traitements sylvicoles sur la faune du sol, 
...
\begin{enumerate}
    ...
    \item De comparer les traitements de coupes forestières et les variables environnementales qui influencent l'utilisation de l'habitat par la faune du sol. 
\end{enumerate}
