...
We sampled eastern red-backed salamanders using artificial coverboards \textit{Plethodon cinereus} at our study sites \citep{hydeSamplingPlethodontidSalamanders2001,mooreComparisonPopulationEastern2009c,hesedUncoveringSalamanderEcology2012,Mazerolle2021Woodlandsalamander}. 
...
\hl{During the summer of 2021, CWD volumes averaged} 2.21 m\up{3}/ha in control sites, 2.55 m\up{3}/ha in partial-cut treatments, 
and 1.17 m\up{3}/ha in clearcut treatments. 
\hl{Control sites had the deepest litter layer, averaging 5.01 cm, while partial cuts and clearcuts showed progressively thinner layers at 3.45 cm and 1.60 cm, respectively. 
Similarly, canopy openness increased with harvesting intensity, 
measuring only 2.92 \% in control sites, rising to 9.42 \% in partial-cut areas, and reaching 67.1 \% in clearcut treatments.}
...
\hl{Our findings suggest that forest harvesting treatments do not directly affect the occupancy probability of large ground beetles and small ground beetles in contradiction with our second hypothesis. }
...
Ces différences méthodologiques rendent difficile la comparaison entre les profondeurs de litière mesurées dans son étude et celles observées dans la nôtre.
\hl{Our methodology differs from Walton's regarding the estimation of litter quantity. We directly measured its depth using a ruler, while Walton weighed the volume of litter within a} 189 m\up{2} circular plot. 
...
Le faible effet que nous avons trouvé durant cette étude ppeuvent également provenir du dispositif utilisé pour l'étude.
Les coupes totales réalisées au dispositif du Lac-des-Amanites sont petites (140 m x 86 m) et entourées d’une matrice forestière proche peu coupée. 
Il est possible que dans ce contexte spatial (taille + positionnement), les coupes totales n'est que peu d’impacts négatifs sur les taxons étudié.
