...
\hl{We predicted that the most intense treatments (clearcutting followed by site preparation) would decrease CWD. }
...
\hl{The hypothesis related to our second objective states that harvest treatments could alter directly habitat use by soil fauna. 
...
\hl{The second hypothesis also suggested that logging would directly reduce the occupancy probability of ground beetles. }
...
The hypothesis related to our second objective states that harvest treatments alter habitat use by soil fauna both directly and indirectly through the trophic network, from predators to prey.

We predicted that logging treatments would impact the occupancy of salamanders and large ground beetles, which subsequently alters small ground beetles occupancy and finally the springtails biomass.
