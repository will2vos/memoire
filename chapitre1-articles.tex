...
Notre étude à globalement observé peu d'effets de traitement de coupes forestières sur les groupes d'espèces étudiés, que par l'effet direct des coupes sur chacun des groupe individuellement ou par l'effet indirect d'un groupe d'espèces sur un autre. 

Les résulats que nous avons obtenue ne soutiennent donc pas notre prédiction puisque le nous n'avons observé qu'un effet marginale de es traitement de coupes forestières sur la probabilité d'occupation des salamandre.
Les probabilité d'occupation est ainsi plus élevé dans les traitement de coupe partielle que dans les traitements de coupes totale.
Ce résultat concorde avec ce que l'on retrouve dans la litérature, puisque plusieurs étude on observé des impactes négatif des traitement de coupe total sur les salamandre mais pas dediférence entre les coupes partielle et les témoins.
Cette différence entre les coupes totales et les coupes partielle et souvent attribuable a la capacité des coupe partielle a conserver les attribut forestier propices a la physiologie de la salamandre.
Malgré la recolte de bois, les coupes partielle permette le maintient du couvert forestier et favorise également un retour rapide de la végétation de sous-étage.
Cela contribue a minimiser les rayonnement solaire atteignantn le sol et a diminuer l'intensité des vents.
cela permet un meilleur maintient des conditions de température et d'humidité à la surface du sol nécessaire au salamandres \citep{Raybuck2015silviculturalpractices} 
Les traitement de coupes partielles sont aussi reconnue pour contenir un des plus important volume de débris ligneux paris les traitement sylvicoles.
La présence des salamandre dans un milieu est souvent associé au volume de débris ligneux puisque ceux -ci servent de refuge permettant aux salamandre de maintenir la température et l'humidité nécéssaire pour leur respiration cutanée et éviter la déssication.
...
% Résultats
Nos résultats montre que 5 ans après l'application des traitements, la probabilité d'occupation des salamandres est plus élevé dans les coupes partielles comparativement aux coupes totale, cependant l'effet observé reste marginale.
Mais qu'il n'y a pas de différence de probabilité d'occupation entre les témoins et les traitements de coupe partielle, ni avec les traitement de coupe totale.

relativement similaire a Mazerolle2021Woodlandsalamander n'a pas observé de différence d'abondace des salamandre entre les traitements de coupe totale et le traitement de coupe partielle, ni dans la comparaison entre ces deux traitements par rapport au témoins toute taille de salamandre confondu. N-mixture

% bribe de texte

Nos résultat montre ainsi la capcité des coupe partielles à maintenir un environnement plus favoriable pour l'utilisation de l'habitat par les salamandre, ce qui concorde avec ce qui a été observé dans la littératture.
De nombreuse étude on observé un impacte négatif des traitement de coupe totale sur les amphibien et plus particulièrement sur les salamandres \citep{Cantrell2013Shortterm}.
A l'inverse plusieurs étude n'ont pas observé de différence entre les traitement de coupe partielle et les témoins.
La plupart des études mette ainsi en avant la capacité des traitement de coupes partielle a maintenir les attribut forestier nécessaire pour maintenir des conditions propices pour l'utilisation de l'habitat par les salamandres.

Notre étude n'a cependant pas permis d'observer une différence entre les témoins et les coupe total ce qui diffère de ce qui est généralement observé dans la littérature.
Les traitements de coupe totale sont souvent reconnue pour avoir un impact les salamandres sur une courte période \citep{Hocking2013Effectsexperimental,Chaudhary2016Impactforest}
Nous attribuons cette différence de constat a un faible nombre d'individus capturée lors de notre étude ce qui amène des uintervalle de confiance large limitant notre capacité a observer un effet.
Ash1997DisappearanceReturn on trouvé que les salamandre retrouvé l'abondance  d'avant coupe total 4-6 ans après l'applications de la coupe et que ce retour correspondais a la réapparition de la litière.
Cependant nos mesure de litière ne nous permette pas de soutenir cette explication. 

La différence observé entre les coupe total et les coupe partielle peut être attribuable aux fait les traitements de coupe partielle ont une meilleurs capacité de retention d'attribut favorable a l'utilisation d'habitat apr les salamandre.
...
Une plus grande rétention du couvert forestier limite la quantité de rayonnement solaire atteignant le sol, ce qui permet de maintenir des microclimats humide et frais, compatibles avec la physiologie des salamandres \citep{Homyack2011Energeticssurfaceactive}
...
La présence de refuge temporaire comme le débris ligneux et autre microstrucutre joue ainsi un rôle prédominant dans leur écologie puisuq'il permette au salamandre de se maintenir a la surface la ou elle s'alimente . 

La différence observé dans la probabilité d'occupation entre les coupes totale et les coupes partielle peut être attribuable à la différence dans la qualité d'habitat.

% coupe partielle
Nos résultats montre que le traitement de coupe partielle ne présente pas de différence pour la probabilité d'occupation des salamandre par rappport au témoins 
mais qu'en revanche la probabilité d'occupation est plus élevé que dans les traitement de coupe totale.

Bien que notre effet soit marginale, cette observation concorde avec ce que l'on retrouve dans la litératture . 
Plusieurs études ont ainsi noté une absence de différence entre les témoins et les coupe partielle sur l'abondance des salamandre \citep{McKenny2006Effectsstructural,Mazerolle2021Woodlandsalamander,Ochs2022Responseterrestrial}. 

D'autres études ont observé une réduction de l'abondance relative des salamandres dans les coupes partielles juste après la première phase de récolte \citep{Harpole1999Effectsseven,Knapp2003Initialeffects,Morneault2004effectshelterwood}
Cependant, au moins une étude a montré que ces effets ne durent que peu de temps (moins de 5 ans) \citep{Morneault2004effectshelterwood}. 

La différence entre les coupe partielle et les coupe totale s'expliquerais essentiellement par la capacité des coupes partielle a préserver des attributs environnementaux favorable à l'utilisation de l'habitat par la salamandre.
Plusieurs étude on ainsi observé que les coupe partielle permetté de maintenir des charactéristique d'habitat propice au maintient de l'abondance des salamandre dans le milieu. 
Cette capacité des coupe partielle a préservé l'utillisation de l'habitat pas les salamandre serait nottament du a la capacité des coupes partielle a préservé plusieurs types d'attributs forestiers.

% Canopé

La réduction de la couverture de la canopée a souvent un effet immédiat sur les salamandres cendrées \citep{Knapp2003Initialeffects,Mossman2019Twosalamander}. 

La canopée en grande partie conservé dans les coupes partielles est une des raison qui pourrait expliquer l'impact limité de ce traitement par rapport aux coupes totales.
Le retention d'arbre dans les coupes partielle permette une plus grand plus grand proportion de couvert forestier ce qui limite l'entrée de rayonnement solaire au sol et réduit la présence de vents extrême. 
Cela permet de maintenir des température plus fraiche et de maintenir les condition d'humidité favorable pour les contrainte physiologique des salamandres.
Les coupe partielle retiendrais ainsi suffisamment de couvert forestier pour éviter le déclin des salamandre observé dans les coupe totale.
Plusieurs étude on ainsi observé une relation positive entre l'abondance des salamandre cendrée et le couvert de la canopé \citep{Otto2014ComparingPopulation}



% végétation de sous étage
L'absence de différence entre les traitement de coupe partielle et les témnoins peut être due au fait que les traitement de coupe partielle favorise un retour rapide de la végétation de sous-étage et ainsi un meilleur maintient des conditions de température et d'humidité à la surface du sol nécessaire au salamandres \citep{Raybuck2015silviculturalpractices}

% CWD
La plus forte probabilité d'occupation des salamandres cendrées dans les traitement de coupe partielle peut aussi être expliqué par la présence d'un plus grand volume de débris ligneux \citep{McKenny2006Effectsstructural,Nolet2018Comparingeffects,Mazerolle2021Woodlandsalamander}. 
Les débris ligneux représente des refuges temporaires pour les salamandres leur permettant de maintenir une température et une humidité propice a la surface lorsque les condition extérieur sont défavorable.
L'abondance des salamandres cendrée salamandre cendrée étant fortement associé au volume de débris ligneux.

À l'inverse une diminution de CWD limite la disponibilité des refuges en surface lors que les conditons environnementale sont difficile, réduisant ainsi le temps que les salamandres passent à la surface du sol pour se nourrir et se reproduire \citep{Peterman2014Spatialvariation,Achat2015Quantifyingconsequences,Peele2017Effectswoody}

La présence rétention de CWD permettrait également de 
...
Notre absence de différence entre les témoins et les traitement de coupe partielle peuvent sembler surprenant au vue de plusieur étude qui observe négatif des traitement de coupes totale sur l'abondance des salamandres.


Les effets des traitements sur les salamandres semble varier à l'echelle temporelle en effet \cite{Ochs2022Responseterrestrial} n'a pas trouvé d'effet des coupe total sur l'abondance relative des salamandres 
durant les trois première années après la recolte ce qui diffère de l'étude menait par \cite{deMaynadier1995relationshipforest}. 

En revanche Ochs2022Responseterrestrial a observer une diminution significative de l'abondance relative des salamandres durant la période de 4-6 ans après la récoltes sans récupérer durant la période de 7-11 ans post-récolte.
La réponse tardive à l'exploitation forestière suggère que les salamandres pourraient mettre quelques années avant de montrer des réactions perceptibles à cette perturbation \citep{Ochs2022Responseterrestrial}

Macneil and Williams (2014) reported a negative effect of clearcuts and patch cuts on plethodontid salamanders in the first 2–3 years after harvest at the HEE. 
We attribute the lack of such effects in the current study to differing analytical approaches. 
We used negative binomial mixed models within a BACI design, whereas Macneil and Williams (2014) used linear mixed models on square-root transformed count data with post-hoc tests and N-mixture models.

Macneil:
Many studies find that clearcuts negatively impact salamander abundance at the local scale \citep{Petranka1993Effectstimber,Herbeck1999PlethodontidSalamander,Grialou2000effectsforest}
while \citep{Renken2004EffectsForest} found no such effect at the landscape scale. 


Demaynadier:
effet negative des coupe total sur l'abondance des salamandres


% temps de récupération des populations

Nolet 2014: 
Tilghman, Ramee, and Marsh (2012) observed that populations generally recovered as the forest regenerated, 
while Homyack and Haas  (2009) observed no recovery 13 years after harvesting following the
...
Globalement, nous n'avons pas observé de différence dans de probabilité d'occupation des carabes entre les différents traitement de coupe, que ce soit pour le groupe des petits carabes ou pour le groupe des gros carabes.

\cite{Kudrin2023metaanalysiseffects} ont observé que l'abondance des carabes diminué dans les traitements de coupe totale mais pas dans les traitements de coupes 
partielle.
...
L'application de coupe total amène la formation de nouveau habitat ce favorise la colonisation par de nouvelles espèces \citep{Niemela2007effectsforestry,Pohl2007Rovebeetles}
les traitement de coupe total amène aussi un changement dans la composition taxonomique ou on observe une disparition des espèces associé au milieu fermé et une colonisation par les espèces associé au milieu ouvert \citep{Kudrin2023metaanalysiseffects}



Staab:
Indeed, relationships between large body size and threat or decline have been shown for several insect taxa including moths32, ground beetles (Nolte2019Habitatspecialization)
