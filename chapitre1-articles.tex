...
% Otto2013Amphibianresponse
% Bailey2004Estimatingsite
% Rooney2000impactsalamander
% Hocking2014Effectsredbacked
% Ovaska1988Predatorybehavior

L’impact des perturbations forestières sur les tendances des populations peut être étroitement lié au niveau trophique \citep{Gotelli2006FoodWebModels,Nolte2019Habitatspecialization}. 
Les espèces les plus sensible aux perturbation se caractérisent généralement par une petite taille de population, une grande taille corporelle et un niveau trophique élevé \citep{Seibold2015Associationextinction,Nolte2019Habitatspecialization,Hagge2021Whatdoes}. 
...
Il semble exister une dynamique complexe au sein des réseaux trophiques du sol forestier en lien avec l'occupation des salamandres \citep{Bailey2004Estimatingsite,Walton2006Salamandersforestfloor,Rooney2000impactsalamander}. 
La diminution des populations de salamandres peut ainsi entraîner des modifications dans la composition des communautés du sol et altérer le fonctionnement des écosystèmes \citep{Hairston1987evolutioncompeting,Wyman1998Experimentalassessment,Rooney2000impactsalamander,Walton2005Contrastingeffects}.

Cependant, dans notre étude, les perturbations causées par les coupes forestières ne semblent pas se propager à travers le réseau trophique, contrairement à notre hypothèse initiale, 
puisqu’aucun effet indirect n’a été mesuré. 
Plus précisément, les carabes de petite taille ne semblent pas être affectés par la probabilité d’occupation des salamandres, et la biomasse des collemboles n’a pas été influencée par la probabilité d’occupation des salamandres et des carabes.

Plusieurs études ont néanmoins suggéré une relation complexe entre la salamandre cendrée et les arthropodes prédateurs \citep{Gall2003BehavioralInteractions,Walton2006Salamandersforestfloor,Hickerson2018Behavioralinteractions}. 
La relation entre les salamandres et les carabes semble toutefois varier selon les études. 
Par exemple, \cite{Gall2003BehavioralInteractionsa} et \cite{Ovaska1988Predatorybehavior} ont observé des comportements agressifs entre les deux taxons, tandis que \cite{Hickerson2012Interactionsforestfloor} ont rapporté un effet positif des salamandres cendrées sur l’abondance des carabes. 
D’autres recherches n’ont, en revanche, constaté aucun effet des salamandres sur l’abondance des prédateurs intraguilde tels que les carabes, les centipèdes et les araignées \citep{Hocking2013Effectsexperimental}.
Le fait que les salamandres et les carabes utilisent le même type d’habitat, consomment des ressources alimentaires similaires, dépendent de microhabitats communs et que les carabes peuvent faire partie du régime alimentaires des salamandres  
suggère malgré tout des liens étroits entre les deux taxons \citep{Jaeger1980Microhabitatsterrestrial,Lovei1996Ecologybehavior}.

Concernant la relation entre les salamandres et les collemboles, la présence des salamandres peut avoir des effets positifs sur la densité de la mésofaune détritivore 
en réduisant le nombre de compétiteurs ou de prédateurs de collemboles dans leur habitat \citep{Wyman1998Experimentalassessment,Rooney2000impactsalamander,Walton2005Contrastingeffects,Walton2006Salamandersforestfloor}. 
Les salamandres sont des amphibiens territoriaux qui défende leur habitat pour préserver les ressource alimentaires et les attribut favorable à leur survie \citep{Gall2003BehavioralInteractions,Hickerson2004Behavioralinteractions,Hickerson2012Interactionsforestfloor}
Elles privilégient également les proies les plus nutritives et deviennent plus sélectives lorsque la densité de leurs proies préférées augmente \citep{Jaeger1981Foragingtactics,Jaeger1982ForagingTactics}.
Par conséquent, la présence de salamandres entraîne une diminution des détritivores de la macrofaune et des prédateurs intermédiaires, ce qui favorise une augmentation de la mésofaune microbivore et détritivore \citep{Rooney2000impactsalamander,Walton2005Contrastingeffects,Walton2006Salamandersforestfloor}. 
À l'inverse, dans les milieux où la densité de macrofaune est plus faible, la présence de salamandres semble avoir un impact négatif sur les collemboles, car la prédation sur la mésofaune y est accrue. 
Par exemple, \cite{Walton2006Salamandersforestfloora} ont observé que la présence de salamandres était associée à une augmentation de collemboles, corrélée à une réduction des populations d'isopodes, de mille-pattes et de pseudoscorpions. 
Toutefois, la présence de salamandres avait un effet légèrement négatif sur les collemboles dans les milieux où la densité initiale de macroinvertébrés était faible. 
Ce résultat est appuyé par d'autres études qui ont également observé un impact négatif des salamandres sur la densité des collemboles \citep{Hickerson2017Easternredbacked}. 
Enfin, certaines recherches, n’ont relevé aucun effet des salamandres sur la mésofaune ainsi que sur la décomposition de la matière organique, ce qui concorde avec nos observations \citep{Hocking2013Effectsexperimental,Hocking2014Effectsredbacked}.

la régulation des salamandres sur les communautés d'invertébrés semblent dépendre en partie de la composition de cette communauté et de l'hétérogénéité de l'habitat \citep{MichaelWaltonSalamandersforestfloor2005,Walton2006Salamandersforestfloor,Walton2013Topregulationlitter,Best2014trophicrole}.
Par exemple, \cite{Walton2013Topregulationlitter} a observé qu'une litière épaisse entraîne une augmentation du nombre de prédateurs invertébrés et une diminution de l'efficacité des salamandres à exclure les compétiteurs, 
ce qui accroît la prédation globale sur la mésofaune. 
Toutefois nos résultats n'appuie pas ces observations car malgré des différences significatives de profondeur de litière entre nos différents traitements de coupes, nous n’avons pas observé de variations au sein du réseau trophique.
