...
At the stand level, logging often results in an overrepresentation of early-successional forests, reducing later successional stages \citep{Cyr2009Forestmanagement,Boucher2017Cumulativepatterns}. 
...
Logging plays a major role in silvicultural treatments that significantly affect natural environments. 
...
Specifically, we estimated the effects of partial-cut and clear-cut on CWD volume, canopy openness and litter depth. 
...
Our study found that springtail biomass does not appear to be affected by logging treatments. 
This result diverges from the common tendency, where increased disturbance intensity leads to a decline in springtail abundance \citep{Lindo2004Forestfloor,Laigle2021Directindirect,Kudrin2023metaanalysiseffects}. 
