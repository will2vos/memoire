...
Clear-cutting treatments had lower CWD volumes compared to partial cutting (95\% CI: [-1.15, -0.43]) (Figure \ref{fig:envar} A, Table \ref{tab:overstoryenvar}). 
...
\hl{Open, warmer, and drier habitats, such as those created by clear-cuts, are favored by many ground beetle species commonly found in grasslands and similar environments. }
