...
\hl{During the summer of 2021, CWD volumes averaged} 2.21 m\up{3}/ha (SD = 0.014 m\up{3}/ha) in control sites, 2.55 m\up{3}/ha (SD = 0,004 m\up{3}/ha) in partial-cut treatments, 
and 1.17 m\up{3}/ha (SD = 0,002 m\up{3}/ha) in clearcut treatments (Figure \ref{fig:envar_raw} A). 
