...
Cependant il nous n'vaons pas observé de différence significative entre les témoins par rapport aux deux traitements de coupes. 
...
Les traitement de coupe totals sont souvent réputé pour avoir un impcat négatif sur les salamandres \citep{Chaudhary2016Impactforest}. 
En revanche les coupe partielle sont reconnue pour maintenir des charactéristique d'habitat propice au maintient des salamandre dans le milieu comme la profondeur de litière ou le volume de débris ligneux. 

En ce qui concerne l'impacts des traitements de coupe forestières sur les différent groupes d'espèces, les seuls effet que nous avons observé sont les impact directe des coupes forestières sur la probabilité d'occurence des salamandres cendrée. 
Notre étude montre uque la probabiltié d'occupantion des salamandre est marginalement plus faibel dans les traitement de coupe partielle que dans les traitements de coupe totales. 
Cependant aucune différence n'a était mesuré entre les deux types de coupes par rapport au témoins. 

Nous estimons que la probabilité d'occupation des salamandres diminue significativement dans les traitement de coupe totale comparativement au témoins et au traitment de coupe partielle.
Cependant nos intervalle de confiance étant grand due à un faible nombre d'indivdus capturé ne nous permet pas d'affirmer la diccérence entre les coupes totale et les témoins.

Nos résultats suggère que les traitement de coupe partielle n'affecte pas la probabilité d'occupation des salamandres 5 ans après la coupe, ce qui concorde avec les observations faites dans la litérrature concernant l'abondance \citep{Mazerolle2021Woodlandsalamander}
Nos résultats diffères partiellement de ce que l'on retrouve dans la litératture..

Cantrell2013Shortterm n'a pas observé d'effet de traitement de coupe partielle sur les amphibiens 2 ans après l'applications des traitements

Ash1997DisappearanceReturn on trouvé que les salamandre retrouvé l'abondance  d'avant coupe total 4-6 ans après l'applications de la coupe et que ce reour correspondais a la réapparition de la litière.
...
McKenny2006Effectsstructural n'a pas trouvé de différence de différence d'abondance de salamandre entre les traitement des coupe partielle et les témoins. 
Pour l'auteur se maintient de l'abondance est attribuable au fait que les traitement de coupe partielle préserve un important volume de débris ligneux ce qui doncorde avec nos observations pour le volume de débris ligneux et celle de \cite{Nolet2018Comparingeffects}.
Mazerolle2021Woodlandsalamander on aussi attribué la capacité des traitement de coupe partielle a maintenir une abondance de salamandre à la présence d'un grand volume de débris ligneux ainsi qu'a important pourcentage de recourvrement par les arbustres. 

Les traitements de coupe totale sont souvent réputer pour être les plus délétaire pour les salamandres sur une courte période \citep{Hocking2013Effectsexperimental}
...
La réduction de la probabilité d'occupation observée dans les coupes totales peut s'expliquer par une diminution de la qualité de l'habitat des salamandres, en particulier par la réduction du volume de débris ligneux. 
Cela limite la disponibilité des refuges en surface lors que les conditons environnementale sont difficile, réduisant ainsi le temps que les salamandres passent à la surface du sol pour se nourrir et se reproduire (Achat et al., 2015 ; Peele et al., 2017) (Peterman et Semlitsch, 2014).. 


La probabilité d'occupation des salamandre plus forte dans les traitement de coupes paritelle peux aussi être expliqué par la capacité de coupe partielle a maintenir un pourcentage de fermeture de canopé élevé. 
Différente étude on ainsi démontré auqe 
...
La réduction de la couverture de la canopée a souvent un effet immédiat sur les salamandres des bois (Knapp et al., 2003; Hocking et al., 2013b; Mossman et al., 2019).

Les débris ligneux peuvent améliorer la qualité de l'habitat pour les salamandres cendrées en créant des refuges à la surface qui modèrent les microclimats au niveau du sol forestier.
La rétention de microhabitat permet ainsi au slamandre de rester à la surface pendant une plus longue période. 

Les effet des traitements sur les salamandre semble varier à l'echelle temporelle en effet \cite{Ochs2022Responseterrestrial} n'a pas trouvé d'effet des coupe total sur l'abondance relative des salamandres 
...
Ochs2022Responseterrestrial n'a pas observé de diminution de l'abondance relatives des salamandre dans les traitements de coupe partielle malgré une période de sécheresse l'année de l'échantillonnage.
...
Les coupes progressives peuvent maintenir suffisamment de couvert forestier pour éviter les déclins des populations de salamandres observés dans les coupes à blanc et par trouées, 
en particulier lorsqu'elles sont combinées à une période de sécheresse.
...
Nolet 2014: 
Tilghman, Ramee, and Marsh (2012) observed that populations generally recovered as the forest regenerated, while Homyack and Haas  (2009) observed no recovery 13 years after harvesting following the
...
Les zones de récolte plus petites peuvent avoir des effets moins prononcés sur les salamandres, car les changements dans des facteurs tels que l'exposition au rayonnement solaire et au vent sont moins extrêmes que dans les récoltes de plus grande taille.

Other studies have found reduced salamander relative abundance in shelterwood harvests immediately following the first stage harvest [29, 54, 55], 
however, at least one study found evidence that these effects are only short-lived (,5 years) [55
The largely intact canopy of the shelterwood prepatory cut is the most obvious difference that may account for the limited impact of this treatment compared to clearcuts and group cuts.
...
For instance, Otto et al. (2014) reported that apparent survival of P. cinereus 1–5 years following harvesting increased with canopy cover and the number of CWD objects in experimental enclosures of 9 m2, whereas abundance in the same enclosures was neither related to canopy cover nor CWD. 
For sites of 3600 m2, the authors observed a positive relationship between P. cinereus abundance and canopy cover (Otto et al. 2014).
Mazerolle2021Woodlandsalamander n'a pas observé de différence d'abondace des salamandre entre les traitements de coupe totale et le traitement de coupe partielle, ni dans la comparaison entre ces deux traitements par rapport au témoins toute taille de salamandre confondu. N-mixture
