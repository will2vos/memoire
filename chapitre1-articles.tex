...
Notre étude montre que la biomasse des collemboles ne semble être affecté par les diffrents traitements de coupe.
Ce résultats diffère de ce qui est généralement observé dans la littératture mais n'est pas unique pour qui observe généralement une diminution de l'abondance des collemboles avec une intensification des perturbations \citep{Lindo2004Forestfloora,Laigle2021Directindirect}
Toutefois certaines études on observer une augmentation de la densité et de la biomasse des collemboles dans des traitements de coupe partielle (Huhta, 1976; Addison and Barber, 1997) \citep{Huhta1976Effectsclearcutting,Marshall2000Impactsforest}. 
Les traitement de coupes totale démontre habituellement une diminution de l'abondance chez les collemboles \citep{Laigle2021Directindirect,Kudrin2023metaanalysiseffects}.
\cite{Bird1986Effectwholetree} on observé un plus grand nombre d'individus dans les traitement de coupe conventionnel que dans les témoins. 
En revanche, l'absence d'effet entre les coupe partielle est les témoins semble correspondre au études antérieurs \citep{Kudrin2023metaanalysiseffects}.
Le déclin des collemboles dans le traitement de coupe totale est habituellement assosicé a une disparition des ressource alimentaire tels que les débris de bois ou la litière, la biomass fongique \citep{Baath1995Microbialcommunity}.
La diminution habituellement observé chez les collemboles suite a une récolte forestièere sont souvent associé à la perte de micro-habitat tel que le débris ligneux, 
la disparition de la couverture organiques, et la baisse d'humidité ainsque de nutriments \citep{Bird1986Effectwholetree,rousseauForestFloorMesofauna2018}. 
A reduction in forest floor microarthropods following harvesting is likely due to a combination of factors, including a decrease in food availability (organic matter, microbial biomass) and compaction \citep{Lindo2004Forestfloora}
Cependant la diminution significative de littière représente une perte de ressource alimentaire pour les communauté épiédaphique, pouvant entrainant une perte de densité de ce groupe \citep{rousseauForestFloorMesofauna2018}. 

Plusieurs piste peuvent être envisager pour expliquer cette différence de résultats.
Les collemboles, sont considérés comme des organismes de type r — caractérisés par une forte fécondité, un développement rapide et un renouvellement rapide des générations, ce qui permet aux populations de collemboles de se rétablir rapidement après une perturbation \citep{Marshall2000Impactsforest}.
La rétention d'une partie du volume de débris ligneux dans les coupes totales pourrait expliquer le maintien des communautés de collemboles dans ces zones \citep{Rousseau2018Forestfloor}. 
Le débris ligneux peut constituer un habitat et une ressource alimentaire pour les collemboles, même s’ils ne sont pas saproxyliques \citep{Raymond-Leonard2020Deadwood}.
Même si les collemboles sont reconnue pour être très sensible au forte perturbation du sol, la réponse au traitements peux vairer selon le type de communauté.
Les collemboles hémiédaphique sont par exemple plus associé au sol des forêt mature et sont ainsi plus souvent affecté lors de perturbations \citep{Laigle2021Directindirect}.
À l'inverse, les espèces épiédaphiques tolère un plus haut niveau de perturbation ainsi que des habitats xéric \citep{Makkonen2011Traitsexplain,Rousseau2019Woodybiomass}. 


Une explication pouvant aider a comprendre la différennce de résultat serait le fait que notre mesure de la biomasse provient de l'ensemble de collemboles trouvé dans la litière, le surface du sol et a l'intérieur du sol. 
Ainsi le changement des condition environnementale suite aux coupe aurait nuire a une certaine communauté mais préservé une autre communauté sans que nous puissions le mesurer a partir de la biomasse totale. 




l'augmentation de débris et de racine morte suite a un traitement de coupe peux aussi avoir pour effet d'augmenter la densité de collemboles dans un milieu durant le première années suivant une coupes \citep{Marshall2000Impactsforest}. 
\cite{Huhta1976Effectsclearcutting} on ainsi observé une augmentation de la densité et de la biomasse des collemboles durant les premièere années suivant une coupe totale, qui se sont par revenu a la normale 6 ans après la coupe

traitement de coupe forestièere peuvent aussi produire un apport important de nourriture 
Marshall2000Impactsforest
Others, such as collembolans, with many parthenogenic species, respond quickly to the increased availability of food, including dead roots and other debris, left on-site from harvesting (Addison and Barber, 1997).
Among the Collembola, Isotomiella minor and Protaphorura parvicornis (Addison and Barber, 1997) and Anuro phorus septentrionalis and Ballistura libra (Seta»la» and Marshall, 1994) were more abundant in clearcuts than in the uncut forest blocks.
However, Addison and Barber (1997) found fewer species of collembolans and carabid beetles in clearcuts compared to shelterwoods.
