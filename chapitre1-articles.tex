...
La différence dans la probabilité d'occupation des salamandre entre les coupe partielle et les coupe totale s'expliquerait essentiellement 
par la capacité des coupes partielle a préserver  une qualité d'habitat en maintenant des attributs forestiers favorable à la salamandre.
...
Les débris ligneux permettent au salamandre de se refugier lorsque les conditions environnementale a la surface devienne défavorable et ainsi de maintenir une température et une humidité propices pour leur besoin physiologique. 
La perte de CWD que l'on retrouve dans les traitement de coupe totale réduit ainsi le temps que les salamandres passent à la surface du sol pour se nourrir et se reproduire en plus d'augmenter les risque de déssication \citep{Peterman2014Spatialvariation,Achat2015Quantifyingconsequences,Peele2017Effectswoody}
...
Ces deux facteurs limite l'entrée de rayonnement solaire au sol et réduit la présence de vents extrême et maintiennent des conditions de température et d'humidité à la surface du sol fovarable pour salamandres cendrées.
Plusieurs études ont ainsi observé une relation positive entre l'abondance des salamandre cendrée et le couvert de la canopé ainsi qu'un effet immédiat de la réduction de la couverture de la canopée sur l'abondance les salamandres cendrées \citep{Knapp2003Initialeffects,Otto2014ComparingPopulation,Mossman2019Twosalamander}.

La quantité de litière pourrait également contribuer à la différence observer dans la probabilité d'occupation des salamandre.
...
Bien que la période de temps après coupe soit similaire a la notre. nos résultats 



Aucun effet directe des coupes forestières sur les deux groupes de carabes et les collemboles n'a été observé.
Les résulats que nous avons obtenue ne soutiennent donc pas notre prédiction puisque nous n'avons observé qu'un effet marginale de des traitements de coupes forestières sur la probabilité d'occupation des salamandre.
