...
\begin{figure}[ht!]
	\centering
	\includegraphics[scale=0.20]{fig_area2.png}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[scale=0.60]{fig_blockSU.png}
...
%% tableau présentant les comparaison , avec les intervalle de confiance + beta ( voire tableau 2 de mazerolle 2021)
